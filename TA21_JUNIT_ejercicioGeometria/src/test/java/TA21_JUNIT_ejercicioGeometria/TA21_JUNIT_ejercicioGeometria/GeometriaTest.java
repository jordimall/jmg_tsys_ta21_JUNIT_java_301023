...
class GeometriaTest {
	...
	private static Stream<Arguments> getFormatConstructorId() {
		return Stream.of(Arguments.of(1, "cuadrado", 1), Arguments.of(7, "Romboide", 7),
				Arguments.of(5, "Pentagono", 5));
	}

	private static Stream<Arguments> getFormatAreaCuadrado() {
		return Stream.of(Arguments.of(25, 5, 1), Arguments.of(4, 2, 1), Arguments.of(49, 7, 1));
	}

	private static Stream<Arguments> getFormatAreaCirculo() {
		return Stream.of(Arguments.of(78.54, 5, 1), Arguments.of(314, 10, 1), Arguments.of(201.06, 8, 1));
	}

	private static Stream<Arguments> getFormatAreaTriangulo() {
		return Stream.of(Arguments.of(10, 5, 4, 1), Arguments.of(12, 4, 6, 1), Arguments.of(90, 30, 6, 1));
	}

	private static Stream<Arguments> getFormatAreaRectangulo() {
		return Stream.of(Arguments.of(15, 5, 3, 1), Arguments.of(225, 25, 9, 1), Arguments.of(180, 30, 6, 1));
	}

	private static Stream<Arguments> getFormatAreaTrapecio() {
		return Stream.of(Arguments.of(42, 10, 5, 6, 1), Arguments.of(119, 25, 9, 7, 1), Arguments.of(91, 23, 3, 7, 1));
	}
	...
	private static Stream<Arguments> getFormatFigura() {
		return Stream.of(Arguments.of("cuadrado", 1), Arguments.of("Circulo", 2), Arguments.of("Triangulo", 3),
				...
				Arguments.of("Romboide", 7), Arguments.of("Trapecio", 8), Arguments.of("Default", 23));
	}

	private static Stream<Arguments> getFormatGetterID() {
		return Stream.of(Arguments.of(1, 1), Arguments.of(7, 7), Arguments.of(5, 5));
	}
	...
	private static Stream<Arguments> getFormatGetterNombre() {
		return Stream.of(Arguments.of("cuadrado", 1), Arguments.of("Romboide", 7), Arguments.of("Pentagono", 5));
	}

	private static Stream<Arguments> getFormatSetterNombre() {
		return Stream.of(Arguments.of("cuadrado", "cuadrado"),
				Arguments.of("Triangulo Hequilatero", "Triangulo Hequilatero"), Arguments.of("Tetaedreo", "Tetaedreo"));
	}

	private static Stream<Arguments> getFormatToString() {
		return Stream.of(Arguments.of("Geometria [id=1, nom=cuadrado, area=25.0]", 1, 5),
